...
class Professeur(models.Model):
    ...
    ID_Annee = models.ForeignKey(Annee, on_delete=models.CASCADE, default=None)
    ID_Classe = models.ForeignKey(Classe, on_delete=models.CASCADE, default=None)
    ID_Modul = models.ForeignKey(Modul, on_delete=models.CASCADE, default=None)
